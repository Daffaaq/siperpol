                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('dosen.create') }}"
                            class="{{ request()->routeIs('dosen.create') ? 'active' : '' }}">Create Dosen</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pendidikan_terakhir_dosen" id="pendidikan_terakhir_dosen"
                                    ...
                                    value="{{ old('pendidikan_terakhir_dosen') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_kelamin_dosen" id="jenis_kelamin_dosen"
                                    ...
                                    <option value="L" {{ old('jenis_kelamin_dosen') == 'L' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="P" {{ old('jenis_kelamin_dosen') == 'P' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_kepegawaian_dosen" id="status_kepegawaian_dosen"
                                    ...
                                    <option value="PNS"
                                        {{ old('status_kepegawaian_dosen') == 'PNS' ? 'selected' : '' }}>PNS</option>
                                    <option value="Honorer"
                                        {{ old('status_kepegawaian_dosen') == 'Honorer' ? 'selected' : '' }}>Honorer
                                    </option>
                                    <option value="Lainnya"
                                        {{ old('status_kepegawaian_dosen') == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
