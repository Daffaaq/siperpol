                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('prodi.edit', $prodi->id) }}"
                            class="{{ request()->routeIs('prodi.edit') ? 'active' : '' }}">Edit Prodi</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                        ...
                        <select name="jurusans_id" id="jurusans_id"
                            ...
                            @foreach ($jurusans as $jurusan)
                                <option value="{{ $jurusan->id }}"
                                    {{ old('jurusans_id', $prodi->jurusans_id) == $jurusan->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="is_active" id="active" value="1"
                                ...
                                {{ old('is_active', $prodi->is_active) == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="active">Active</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" name="is_active" id="inactive" value="0"
                                class="form-check-input @error('is_active') is-invalid @enderror"
                                {{ old('is_active', $prodi->is_active) == '0' ? 'checked' : '' }}>
