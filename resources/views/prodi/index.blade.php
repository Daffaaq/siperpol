        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="ProdiTables" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Prodi</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataMaster = $('#ProdiTables').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        searchable: false,
                        render: function(data) {
                            let showUrl = `/master-management/prodi/${data}`;
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/master-management/prodi/${id}`;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        data: {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#ProdiTables').DataTable().ajax.reload();
