                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('organisasi.create') }}"
                            class="{{ request()->routeIs('organisasi.create') ? 'active' : '' }}">Create Organisasi
                            Intra</a>
                    </li>
                </ol>
            </div>
                ...
                <form method="POST" action="{{ route('organisasi.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_organisasi_intra" id="nama_organisasi_intra"
                            ...
                            value="{{ old('nama_organisasi_intra') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_organisasi_intra" id="kode_organisasi_intra"
                            ...
                            value="{{ old('kode_organisasi_intra') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipe_organisasi_intra" id="tipe_organisasi_intra"
                            ...
                            <option value="jurusan" {{ old('tipe_organisasi_intra') == 'jurusan' ? 'selected' : '' }}>
                                Jurusan</option>
                            <option value="non-jurusan"
                                {{ old('tipe_organisasi_intra') == 'non-jurusan' ? 'selected' : '' }}>Non-Jurusan</option>
                            <option value="lembaga-tinggi"
                                {{ old('tipe_organisasi_intra') == 'lembaga-tinggi' ? 'selected' : '' }}>Lembaga Tinggi
                            </option>
                        </select>
                    ...
                    <!-- Password Ketua Umum -->
                    <div class="form-group">
                        <label for="password_ketua_umum">Password Ketua Umum:</label>
