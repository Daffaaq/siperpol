                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('tipe-dokumen-peminjaman.create') }}"
                            class="{{ request()->routeIs('tipe-dokumen-peminjaman.create') ? 'active' : '' }}">
                            Create Tipe Dokumen Peminjaman
                        </a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <!-- Tipe Dokumen Peminjaman Create Form -->
                <form method="POST" action="{{ route('tipe-dokumen-peminjaman.store') }}">
                    @csrf
