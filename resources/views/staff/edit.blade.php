                ...
                <form method="POST" action="{{ route('staff.update', $staff->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email_staff" id="email_staff" placeholder="Email Staff"
                                    ...
                                    value="{{ old('email_staff', $staff->email_staff) }}">
                                @error('email_staff')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_staff" id="alamat_staff" placeholder="Alamat Staff"
                                    ...
                                    value="{{ old('alamat_staff', $staff->alamat_staff) }}">
                                @error('alamat_staff')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Status Kepegawaian Lainnya (will show if 'Lainnya' is selected) -->
                            <div class="form-group" id="status_kepegawaian_lainnya_group" style="display: none;">
                                ...
                                <input type="text" name="status_kepegawaian_lainnya" id="status_kepegawaian_lainnya"
                                    ...
                                    value="{{ old('status_kepegawaian_lainnya', $staff->status_kepegawaian_lainnya) }}">
                            ...
                            <!-- Password Staff -->
                            <div class="form-group">
                                <label for="password_staff">Password Staff:</label>
